...
db.collection("reports")
  ...
  .then((doc) => {
    ...
    if (isBlocked == "Yes") {
      ...
      document.getElementById("blockedNo").checked = true;
    }
    var isFixing = docData.fixes;
    if (isFixing == "Yes") {
      document.getElementById("fixYes").checked = true;
    } else if (isFixing == "No") {
      document.getElementById("fixNo").checked = true;
    }
